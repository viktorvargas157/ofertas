...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.almacen_connection' => 'getDoctrine_Dbal_AlmacenConnectionService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/xampp/htdocs/ofertas/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/xampp/htdocs/ofertas/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/xampp/htdocs/ofertas/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/xampp/htdocs/ofertas/app/Resources');
    ...
    /**
     * Gets the 'doctrine.dbal.almacen_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_AlmacenConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.almacen'));
    ...
    /**
     * Gets the 'doctrine.orm.almacen_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_AlmacenEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_almacen_46699f68be3b9b5c86974d0e6da8e16a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_almacen_46699f68be3b9b5c86974d0e6da8e16a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_almacen_46699f68be3b9b5c86974d0e6da8e16a');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'F:\\xampp\\htdocs\\ofertas\\src\\CCC\\OfertasBundle\\Entity')), 'CCC\\OfertasBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('OfertasBundle' => 'CCC\\OfertasBundle\\Entity'));
        ...
        $this->services['doctrine.orm.almacen_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.almacen_connection'), $e);

        $this->get('doctrine.orm.almacen_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.almacen_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_AlmacenManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.almacen_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_46699f68be3b9b5c86974d0e6da8e16a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_46699f68be3b9b5c86974d0e6da8e16a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_46699f68be3b9b5c86974d0e6da8e16a');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/xampp/htdocs/ofertas/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'fcb9ebbb410010d365e3b32c74241d080b');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('F:/xampp/htdocs/ofertas/app/logs/dev.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'F:/xampp/htdocs/ofertas/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'F:/xampp/htdocs/ofertas/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1)), 'CCC\\OfertasBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/super/');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/secretaria/');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ingeniero/');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/pres/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/abodago/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comer/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuarios/');

        $o = new \Symfony\Component\Security\Http\AccessMap();
        $o->add($g, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $o->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $o->add($i, array(0 => 'ROLE_SECRETARIA'), NULL);
        $o->add($j, array(0 => 'ROLE_INGENIERO'), NULL);
        $o->add($k, array(0 => 'ROLE_PRESUPUESTISTA'), NULL);
        $o->add($l, array(0 => 'ROLE_ABOGADO'), NULL);
        $o->add($m, array(0 => 'ROLE_COMERCIAL'), NULL);
        $o->add($n, array(0 => 'ROLE_VISOR'), NULL);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/xampp/htdocs/ofertas/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('F:/xampp/htdocs/ofertas/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('F:/xampp/htdocs/ofertas/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/xampp/htdocs/ofertas/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/xampp/htdocs/ofertas/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'F:/xampp/htdocs/ofertas/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'F:/xampp/htdocs/ofertas/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/xampp/htdocs/ofertas/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        ...
        $instance->addPath('F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fcb9ebbb410010d365e3b32c74241d080b');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/xampp/htdocs/ofertas/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('F:/xampp/htdocs/ofertas/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.almacen' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_AlmacenService()
    {
        return $this->services['doctrine.dbal.logger.profiling.almacen'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter(new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_COMERCIAL', 1 => 'ROLE_SECRETARIA', 2 => 'ROLE_INGENIERO', 3 => 'ROLE_PRESUPUESTISTA', 4 => 'ROLE_ABOGADO'), 'ROLE_COMERCIAL' => array(0 => 'ROLE_VISOR'), 'ROLE_SECRETARIA' => array(0 => 'ROLE_VISOR'), 'ROLE_INGENIERO' => array(0 => 'ROLE_VISOR'), 'ROLE_PRESUPUESTISTA' => array(0 => 'ROLE_VISOR'), 'ROLE_ABOGADO' => array(0 => 'ROLE_VISOR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_COMERCIAL', 1 => 'ROLE_ECONOMIA', 2 => 'ROLE_ADMIN', 3 => 'ROLE_INGENIERO', 4 => 'ROLE_PRESUPUESTISTA', 5 => 'ROLE_ALLOWED_TO_SWITCH')))), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($this->get('security.authentication.trust_resolver'))), 'affirmative', false, true);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('viktor', 'cab64bc3aa59d00c6323dac58e1492176b389841', array(0 => 'ROLE_SUPER_ADMIN')));
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'CCC\\OfertasBundle\\Entity\\Usuario', 'usuario', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/xampp/htdocs/ofertas/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/xampp/htdocs/ofertas/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/xampp/htdocs/ofertas/app/cache/dev',
            'kernel.logs_dir' => 'F:/xampp/htdocs/ofertas/app/logs',
            ...
            'mailer_user' => 'alertas@ccc.co.cu',
            'mailer_password' => 'Prueba2017',
            'locale' => 'en',
            'secret' => 'fcb9ebbb410010d365e3b32c74241d080b',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'F:/xampp/htdocs/ofertas/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'fcb9ebbb410010d365e3b32c74241d080b',
            ...
            'session.save_path' => 'F:/xampp/htdocs/ofertas/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'F:\\xampp\\htdocs\\ofertas\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:F:/xampp/htdocs/ofertas/app/cache/dev/profiler',
            ...
            'router.resource' => 'F:/xampp/htdocs/ofertas/app/cache/dev/assetic/routing.yml',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_ADMIN' => array(
                    ...
                    1 => 'ROLE_SECRETARIA',
                    2 => 'ROLE_INGENIERO',
                    3 => 'ROLE_PRESUPUESTISTA',
                    4 => 'ROLE_ABOGADO',
                ),
                'ROLE_COMERCIAL' => array(
                    0 => 'ROLE_VISOR',
                ),
                'ROLE_SECRETARIA' => array(
                    0 => 'ROLE_VISOR',
                ),
                'ROLE_INGENIERO' => array(
                    0 => 'ROLE_VISOR',
                ),
                'ROLE_PRESUPUESTISTA' => array(
                    0 => 'ROLE_VISOR',
                ),
                'ROLE_ABOGADO' => array(
                    0 => 'ROLE_VISOR',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/xampp/htdocs/ofertas/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.1.1',
            ...
            'assetic.cache_dir' => 'F:/xampp/htdocs/ofertas/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'F:/xampp/htdocs/ofertas/app/../web',
            'assetic.write_to' => 'F:/xampp/htdocs/ofertas/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/xampp/htdocs/ofertas/app/cache/dev/doctrine/orm/Proxies',
