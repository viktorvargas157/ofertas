 ...
 */
class ContactosPosibleCliente extends \CCC\OfertasBundle\Entity\ContactosPosibleCliente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setIdPosibleCliente($idPosibleCliente);
    }

    public function getIdPosibleCliente()
    {
        $this->__load();
        return parent::getIdPosibleCliente();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'email', 'idPosibleCliente', 'telefonos');
    }
